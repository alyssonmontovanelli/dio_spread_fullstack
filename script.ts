...
(function () {
 const $ = (seletor: string): HTMLInputElement | null => document.querySelector(seletor);
 ...
 function patio(){
  ...
  function adicionar(veiculo: Veiculo, salva?: boolean){
   ...
   `;   
   linhas.querySelector(".delete")?.addEventListener("click", function(){
    remover(this.dataset.placa)
   })

   $("#patio")?.appendChild(linhas);
